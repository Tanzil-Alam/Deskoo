...
// Optional custom overlay callback for drawing sprites, props, and animations
void (*onDrawOverlay)(AdafruitDisplay *disp) = nullptr;

void setOverlayCallback(void (*callback)(AdafruitDisplay *disp)) {
  onDrawOverlay = callback;
}
...
void drawEyes(){
  ...
  // Call optional external sprite/overlay callback
